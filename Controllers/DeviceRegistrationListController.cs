...
{
    [RoutePrefix("Api/DeviceRegistrationList")]
    public class DeviceRegistrationListController : ApiController
    {
        private Repository<string> Repositorys;
        private HttpResponseMessage resp;

        public DeviceRegistrationListController()
        {
            Repositorys = new Repository<string>();
            Repositorys.OperationString = "DeviceRegistrationList";
        }
        //下載SeriesNumber列表
